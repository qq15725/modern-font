/**
 * The 258 standard Macintosh glyph names, in order. Used by `post` table
 * formats 1 and 2: a glyphNameIndex < 258 refers into this list.
 *
 * @link https://developer.apple.com/fonts/TrueType-Reference-Manual/RM06/Chap6post.html
 */
export const macGlyphNames: string[] = [
